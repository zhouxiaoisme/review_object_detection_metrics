...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btn_stats_gt.setGeometry(QtCore.QRect(260, 10, 271, 27))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.btn_stats_gt.setFont(font)
        self.btn_stats_gt.setStyleSheet("background-color: rgb(164, 228, 255);")
        ...
        self.txb_gt_images_dir.setReadOnly(False)
        ...
        self.txb_gt_dir.setReadOnly(False)
        ...
        self.frame.setGeometry(QtCore.QRect(10, 190, 1191, 91))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.rad_gt_format_coco_json = QtWidgets.QRadioButton(self.frame)
        self.rad_gt_format_coco_json.setGeometry(QtCore.QRect(10, 24, 161, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_coco_json.setFont(font)
        self.rad_gt_format_coco_json.setChecked(False)
        self.rad_gt_format_coco_json.setObjectName("rad_gt_format_coco_json")
        self.lbl_detections_dir_3 = QtWidgets.QLabel(self.frame)
        self.lbl_detections_dir_3.setGeometry(QtCore.QRect(10, -3, 191, 20))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.rad_gt_format_imagenet_xml.setGeometry(QtCore.QRect(470, 24, 151, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_imagenet_xml.setFont(font)
        ...
        self.rad_gt_format_openimages_csv.setGeometry(QtCore.QRect(220, 24, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_openimages_csv.setFont(font)
        ...
        self.rad_gt_format_labelme_xml.setGeometry(QtCore.QRect(220, 54, 151, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_labelme_xml.setFont(font)
        ...
        self.rad_gt_format_pascalvoc_xml.setGeometry(QtCore.QRect(10, 54, 181, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_pascalvoc_xml.setFont(font)
        ...
        self.rad_gt_format_abs_values_text.setGeometry(QtCore.QRect(650, 24, 201, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_abs_values_text.setFont(font)
        ...
        self.rad_gt_format_yolo_text.setGeometry(QtCore.QRect(470, 54, 181, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_yolo_text.setFont(font)
        ...
        self.rad_gt_format_cvat_xml.setGeometry(QtCore.QRect(910, 24, 171, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_cvat_xml.setFont(font)
        self.rad_gt_format_cvat_xml.setObjectName("rad_gt_format_cvat_xml")
        self.rad_gt_format_gdd_json = QtWidgets.QRadioButton(self.frame)
        self.rad_gt_format_gdd_json.setGeometry(QtCore.QRect(650, 34, 391, 71))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_gt_format_gdd_json.setFont(font)
        self.rad_gt_format_gdd_json.setChecked(True)
        self.rad_gt_format_gdd_json.setObjectName("rad_gt_format_gdd_json")
        self.lbl_groundtruth_dir_3 = QtWidgets.QLabel(Dialog)
        self.lbl_groundtruth_dir_3.setGeometry(QtCore.QRect(10, 10, 151, 21))
        font = QtGui.QFont()
        ...
        self.lbl_groundtruth_dir_22.setGeometry(QtCore.QRect(10, 300, 141, 20))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.frame_4.setGeometry(QtCore.QRect(10, 450, 1191, 161))
        self.frame_4.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_4.setObjectName("frame_4")
        self.rad_det_ci_format_text_yolo_rel = QtWidgets.QRadioButton(self.frame_4)
        self.rad_det_ci_format_text_yolo_rel.setGeometry(QtCore.QRect(10, 30, 581, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_ci_format_text_yolo_rel.setFont(font)
        self.rad_det_ci_format_text_yolo_rel.setToolTip("")
        self.rad_det_ci_format_text_yolo_rel.setChecked(False)
        ...
        self.lbl_detections_dir_5.setGeometry(QtCore.QRect(10, 6, 181, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rad_det_ci_format_text_xywh_abs.setGeometry(QtCore.QRect(10, 90, 531, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_ci_format_text_xywh_abs.setFont(font)
        ...
        self.rad_det_ci_format_text_xyx2y2_abs.setGeometry(QtCore.QRect(10, 60, 531, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_ci_format_text_xyx2y2_abs.setFont(font)
        ...
        self.rad_det_format_coco_json.setGeometry(QtCore.QRect(10, 120, 181, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_format_coco_json.setFont(font)
        ...
        self.rad_det_cn_format_text_xyx2y2_abs.setGeometry(QtCore.QRect(600, 60, 531, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_cn_format_text_xyx2y2_abs.setFont(font)
        ...
        self.rad_det_cn_format_text_yolo_rel.setGeometry(QtCore.QRect(600, 30, 591, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_cn_format_text_yolo_rel.setFont(font)
        ...
        self.rad_det_cn_format_text_xywh_abs.setGeometry(QtCore.QRect(600, 90, 531, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_cn_format_text_xywh_abs.setFont(font)
        self.rad_det_cn_format_text_xywh_abs.setObjectName("rad_det_cn_format_text_xywh_abs")
        self.rad_det_format_gdd_json = QtWidgets.QRadioButton(self.frame_4)
        self.rad_det_format_gdd_json.setGeometry(QtCore.QRect(600, 100, 391, 71))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.rad_det_format_gdd_json.setFont(font)
        self.rad_det_format_gdd_json.setChecked(True)
        self.rad_det_format_gdd_json.setObjectName("rad_det_format_gdd_json")
        self.txb_det_dir = QtWidgets.QLineEdit(Dialog)
        self.txb_det_dir.setGeometry(QtCore.QRect(110, 335, 1051, 27))
        self.txb_det_dir.setReadOnly(False)
        self.txb_det_dir.setObjectName("txb_det_dir")
        self.frame_12 = QtWidgets.QFrame(Dialog)
        self.frame_12.setGeometry(QtCore.QRect(10, 692, 1191, 121))
        self.frame_12.setStyleSheet("background-color: rgb(194, 245, 255);")
        self.frame_12.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_12.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_12.setObjectName("frame_12")
        self.lbl_groundtruth_dir_26 = QtWidgets.QLabel(self.frame_12)
        self.lbl_groundtruth_dir_26.setGeometry(QtCore.QRect(10, 3, 281, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.chb_metric_AP75_coco.setGeometry(QtCore.QRect(10, 90, 191, 22))
        ...
        self.chb_metric_AP50_coco.setGeometry(QtCore.QRect(10, 60, 191, 22))
        ...
        self.chb_metric_AP_coco.setGeometry(QtCore.QRect(10, 30, 191, 22))
        ...
        self.chb_metric_AR_max100.setGeometry(QtCore.QRect(500, 90, 111, 22))
        ...
        self.chb_metric_AR_max10.setGeometry(QtCore.QRect(500, 60, 111, 22))
        ...
        self.chb_metric_AR_max1.setGeometry(QtCore.QRect(500, 30, 111, 22))
        ...
        self.chb_metric_APmedium_coco.setGeometry(QtCore.QRect(180, 60, 191, 22))
        ...
        self.chb_metric_APlarge_coco.setGeometry(QtCore.QRect(180, 90, 191, 22))
        ...
        self.chb_metric_APsmall_coco.setGeometry(QtCore.QRect(180, 30, 191, 22))
        ...
        self.chb_metric_AR_medium.setGeometry(QtCore.QRect(640, 60, 111, 22))
        ...
        self.chb_metric_AR_large.setGeometry(QtCore.QRect(640, 90, 111, 22))
        ...
        self.chb_metric_AR_small.setGeometry(QtCore.QRect(640, 30, 111, 22))
        ...
        self.lbl_groundtruth_dir_31.setGeometry(QtCore.QRect(500, 3, 251, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lbl_detections_dir_6.setGeometry(QtCore.QRect(920, 3, 191, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.dsb_IOU_pascal.setGeometry(QtCore.QRect(1030, 25, 81, 27))
        ...
        self.chb_metric_AP_pascal.setGeometry(QtCore.QRect(920, 60, 121, 22))
        ...
        self.chb_metric_mAP_pascal.setGeometry(QtCore.QRect(1050, 60, 71, 22))
        ...
        self.lbl_IOU_thresh.setGeometry(QtCore.QRect(920, 30, 101, 17))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.lbl_IOU_thresh.setFont(font)
        ...
        self.lbl_groundtruth_dir_23.setGeometry(QtCore.QRect(10, 630, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.btn_stats_det.setGeometry(QtCore.QRect(250, 300, 281, 27))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.btn_stats_det.setFont(font)
        self.btn_stats_det.setStyleSheet("background-color: rgb(164, 228, 255);")
        self.btn_stats_det.setObjectName("btn_stats_det")
        self.btn_run = QtWidgets.QPushButton(Dialog)
        self.btn_run.setGeometry(QtCore.QRect(130, 630, 161, 51))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        brush = QtGui.QBrush(QtGui.QColor(152, 255, 230))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.btn_run.setStyleSheet("background-color: rgb(152, 255, 230);")
        ...
        self.lbl_groundtruth_dir_27.setGeometry(QtCore.QRect(110, 125, 531, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(7)
        self.lbl_groundtruth_dir_27.setFont(font)
        ...
        self.btn_output_dir.setGeometry(QtCore.QRect(1170, 820, 31, 27))
        self.btn_output_dir.setObjectName("btn_output_dir")
        self.txb_output_dir = QtWidgets.QLineEdit(Dialog)
        self.txb_output_dir.setGeometry(QtCore.QRect(80, 820, 1081, 27))
        self.txb_output_dir.setReadOnly(False)
        ...
        font.setFamily("Arial")
        font.setPointSize(7)
        self.lbl_groundtruth_dir_29.setFont(font)
        ...
        self.lbl_groundtruth_dir_28.setGeometry(QtCore.QRect(10, 825, 101, 17))
        self.lbl_groundtruth_dir_28.setObjectName("lbl_groundtruth_dir_28")
        self.lbl_gt_version = QtWidgets.QLabel(Dialog)
        self.lbl_gt_version.setGeometry(QtCore.QRect(10, 150, 101, 17))
        self.lbl_gt_version.setObjectName("lbl_gt_version")
        self.txb_gt_version = QtWidgets.QLineEdit(Dialog)
        self.txb_gt_version.setGeometry(QtCore.QRect(110, 150, 1051, 27))
        self.txb_gt_version.setReadOnly(False)
        self.txb_gt_version.setObjectName("txb_gt_version")
        self.line = QtWidgets.QFrame(Dialog)
        self.line.setGeometry(QtCore.QRect(0, 280, 1211, 21))
        self.line.setLineWidth(4)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(Dialog)
        self.line_2.setGeometry(QtCore.QRect(0, 610, 1211, 21))
        self.line_2.setLineWidth(4)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.txb_det_version = QtWidgets.QLineEdit(Dialog)
        self.txb_det_version.setGeometry(QtCore.QRect(110, 420, 1051, 27))
        self.txb_det_version.setReadOnly(False)
        self.txb_det_version.setObjectName("txb_det_version")
        self.lbl_det_version = QtWidgets.QLabel(Dialog)
        self.lbl_det_version.setGeometry(QtCore.QRect(10, 420, 101, 17))
        self.lbl_det_version.setObjectName("lbl_det_version")
        self.chb_appendCurEvalDataToRepo = QtWidgets.QCheckBox(Dialog)
        self.chb_appendCurEvalDataToRepo.setGeometry(QtCore.QRect(300, 640, 321, 31))
        self.chb_appendCurEvalDataToRepo.setObjectName("chb_appendCurEvalDataToRepo")
        self.comb_targetClass = QtWidgets.QComboBox(Dialog)
        self.comb_targetClass.setGeometry(QtCore.QRect(620, 640, 151, 31))
        self.comb_targetClass.setObjectName("comb_targetClass")
        self.frame_2 = QtWidgets.QFrame(Dialog)
        self.frame_2.setGeometry(QtCore.QRect(800, 620, 401, 71))
        self.frame_2.setStyleSheet("border-color: rgb(179, 255, 240);")
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.chb_showF1Score_for_plotRepo = QtWidgets.QCheckBox(self.frame_2)
        self.chb_showF1Score_for_plotRepo.setGeometry(QtCore.QRect(220, 10, 321, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(7)
        self.chb_showF1Score_for_plotRepo.setFont(font)
        self.chb_showF1Score_for_plotRepo.setObjectName("chb_showF1Score_for_plotRepo")
        self.btn_plotRepoPR = QtWidgets.QPushButton(self.frame_2)
        self.btn_plotRepoPR.setGeometry(QtCore.QRect(10, 10, 201, 51))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.NoBrush)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.PlaceholderText, brush)
        self.btn_plotRepoPR.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.btn_plotRepoPR.setFont(font)
        self.btn_plotRepoPR.setStyleSheet("background-color: rgb(152, 255, 230);")
        self.btn_plotRepoPR.setObjectName("btn_plotRepoPR")
        self.chb_showConfidence_for_plotRepo = QtWidgets.QCheckBox(self.frame_2)
        self.chb_showConfidence_for_plotRepo.setGeometry(QtCore.QRect(220, 40, 321, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(7)
        self.chb_showConfidence_for_plotRepo.setFont(font)
        self.chb_showConfidence_for_plotRepo.setObjectName("chb_showConfidence_for_plotRepo")
        ...
        self.btn_plotRepoPR.clicked.connect(Dialog.btn_plotRepoPR_clicked)
        self.chb_appendCurEvalDataToRepo.clicked.connect(Dialog.chb_appendCurEvalDataToRepo_clicked)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.txb_gt_images_dir.setText(_translate("Dialog", "E:\\tmp\\20220429_phoneOptV6\\qst_model_test-429\\benchmark_v2\\高柜\\gt_img"))
        self.txb_gt_dir.setText(_translate("Dialog", "E:\\tmp\\20220429_phoneOptV6\\qst_model_test-429\\benchmark_v2\\高柜"))
        self.btn_gt_dir.setText(_translate("Dialog", "..."))
        self.rad_gt_format_coco_json.setText(_translate("Dialog", "COCO format (.json)"))
        ...
        self.rad_gt_format_gdd_json.setText(_translate("Dialog", "custom annotation json format(similar with COCO\n"
"json format, but no image width, height info)"))
        ...
        self.rad_det_format_gdd_json.setText(_translate("Dialog", "custom annotation json format(similar with COCO\n"
"json format, but no image width, height info)"))
        self.txb_det_dir.setText(_translate("Dialog", "E:\\tmp\\20220429_phoneOptV6\\qst_model_test-429\\高柜模型result"))
        ...
        self.btn_run.setText(_translate("Dialog", "evaluate"))
        ...
        self.txb_output_dir.setText(_translate("Dialog", "e:\\tmp"))
        ...
        self.lbl_gt_version.setText(_translate("Dialog", "Version:"))
        self.txb_gt_version.setText(_translate("Dialog", "20220429_benchmarkv2_高柜场景"))
        self.txb_det_version.setText(_translate("Dialog", "20220429_benchmarkv2_高柜场景"))
        self.lbl_det_version.setText(_translate("Dialog", "Version:"))
        self.chb_appendCurEvalDataToRepo.setText(_translate("Dialog", "append cur PR data to repo for class:"))
        self.chb_showF1Score_for_plotRepo.setText(_translate("Dialog", "show F1Score-Recall"))
        self.btn_plotRepoPR.setToolTip(_translate("Dialog", "The configurations will be applied in a random ground truth image."))
        self.btn_plotRepoPR.setText(_translate("Dialog", "plot repo\'s PR data"))
        self.chb_showConfidence_for_plotRepo.setText(_translate("Dialog", "show Conf-Recall"))
